...
const Person = ({ githubData, databaseData }) => {
  ...
  return (
    <div className={styles.main}>
      ...
      {/* Facelines here */}
      <FacesLine
        people={[{ name: "fake", github: "fake1" }]}
        title="On cohort with..."
      />

      <FacesLine
        people={[{ name: "fakeMentor", github: "mentor" }]}
        title="Mentored by..."
      />

      <FacesLine
        people={[{ name: "fakeCF", github: "CFyeah" }]}
        title="Course facilitated by..."
      />

      <FacesLine
        people={[{ name: "Speaker McSpeaker", github: "speakeasy" }]}
        title="Had talks from..."
      />

      <FacesLine
        people={[{ name: "Great Colleague", github: "user1234" }]}
        title="Works or works with..."
      />
